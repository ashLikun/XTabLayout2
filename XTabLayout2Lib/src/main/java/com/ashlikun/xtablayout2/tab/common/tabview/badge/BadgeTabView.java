 ...
 * 邮箱　　：496546144@qq.com
 *
 * 功能介绍：支持显示角标的title，角标布局可自定义
 */

public class BadgeTabView extends FrameLayout implements IMeasurablePagerTitleView {
    private ITabView mInnerPagerTitleView;
    ...
    public ITabView getInnerPagerTitleView() {
        return mInnerPagerTitleView;
    }

    public void setInnerPagerTitleView(ITabView innerPagerTitleView) {
