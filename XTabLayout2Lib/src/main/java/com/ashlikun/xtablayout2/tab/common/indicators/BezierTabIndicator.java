 ...
 * 邮箱　　：496546144@qq.com
 *
 * 功能介绍：贝塞尔曲线ViewPager指示器，带颜色渐变
 */

public class BezierTabIndicator extends View implements ITabIndicator {
    ...
    public BezierTabIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = XTabUtils.dip2px(context, 3.5);
        mMinCircleRadius = XTabUtils.dip2px(context, 2);
        mYOffset = XTabUtils.dip2px(context, 1.5);
    }
