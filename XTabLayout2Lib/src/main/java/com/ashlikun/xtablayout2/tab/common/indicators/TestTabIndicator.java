 ...
 * 邮箱　　：496546144@qq.com
 * <p>
 * 功能介绍：用于测试的指示器，可用来检测自定义的IMeasurablePagerTitleView是否正确测量内容区域
 */

public class TestTabIndicator extends View implements ITabIndicator {
    ...
    public TestTabIndicator(Context context) {
        super(context);
        init(context);
    }
