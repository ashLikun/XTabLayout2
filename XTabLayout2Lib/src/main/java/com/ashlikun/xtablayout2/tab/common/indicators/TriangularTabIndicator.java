...
/**
 * @author　　: 李坤
 * 创建时间: 2020/7/15 13:23
 * 邮箱　　：496546144@qq.com
 * <p>
 * 功能介绍：带有小尖角的直线指示器
 */
public class TriangularTabIndicator extends View implements ITabIndicator {
    ...
    public TriangularTabIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mTriangleWidth = XTabUtils.dip2px(context, 14);
        mTriangleHeight = XTabUtils.dip2px(context, 8);
    }
