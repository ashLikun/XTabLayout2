...
public class FragmentContainerHelper {
    private List<XTabLayout> mMagicIndicators = new ArrayList<XTabLayout>();
    ...
    public FragmentContainerHelper(XTabLayout magicIndicator) {
    ...
    public void attachMagicIndicator(XTabLayout magicIndicator) {
        mMagicIndicators.add(magicIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (XTabLayout magicIndicator : mMagicIndicators) {
