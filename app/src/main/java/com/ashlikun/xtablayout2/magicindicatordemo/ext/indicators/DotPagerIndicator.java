package com.ashlikun.xtablayout2.magicindicatordemo.xt.indicators;
 ...
 */
public class DotPagerIndicator extends View implements ITabIndicator {
    ...
    public DotPagerIndicator(Context context) {
        ...
        mYOffset = XTabUtils.dip2px(context, 3);
