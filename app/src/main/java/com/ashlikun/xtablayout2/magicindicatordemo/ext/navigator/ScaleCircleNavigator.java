package com.ashlikun.xtablayout2.magicindicatordemo.xt.navigator;
...
public class ScaleCircleNavigator extends View implements ITab, TabHelper.OnNavigatorScrollListener {
    ...
    private TabHelper mNavigatorHelper = new TabHelper();
    ...
    private void init(Context context) {
        ...
        mMinRadius = XTabUtils.dip2px(context, 3);
        mMaxRadius = XTabUtils.dip2px(context, 5);
        mCircleSpacing = XTabUtils.dip2px(context, 8);
    ...
    protected void onDraw(Canvas canvas) {
        for (int i = 0, j = mCirclePoints.size(); i < j; i++) {
            ...
            mPaint.setColor(XTabUtils.eval((radius - mMinRadius) / (mMaxRadius - mMinRadius), mNormalCircleColor, mSelectedCircleColor));
